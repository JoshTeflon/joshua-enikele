...
import joshteflon from '../../assets/svg/joshteflon.png'
                    ...
                    <div className="btn-grp">
                        <div className="btn-grp__contact">
                            <button className={`btn contact_btn ${active ? 'btn-bg-all' : ''}`} onClick={handleActive}>
                                ...
                                <svg width="12" height="12" viewBox="0 0 27 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <SocialBtn style={active ? 'social-btn' : 'no-social-btn'} />
                        </div>
